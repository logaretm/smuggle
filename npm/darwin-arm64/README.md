...
This is the macOS Apple Silicon (arm64) binary for [`smuggle-cli`](https://www.npmjs.com/package/smuggle-cli).
...
The correct platform-specific binary will be selected automatically.
